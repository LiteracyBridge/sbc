  ...
  <div class="coverPage">
    ...
    <div class="coverFooter">
      <span>
        ...
        <a href="mailto:email@example.com">email@company.com</a> | 317.234.8765
      </span>
      <hr />
    </div>
  </div>
...
-->
  <div class="chapterPage">
    ...
    <p class="highlight">
      ...
      aliquam felis, sed porttitor sapien porta et. Mauris vitae condimentum ipsum, sit
      amet euismod elit. Ut quis egestas libero. Duis vitae lacus dui.
    </p>
    <p class="highlightLight">
      Aenean convallis lorem diam, ut imperdiet lectus ornare eget. Vestibulum consequat
      aliquam felis, sed porttitor sapien porta et. Mauris vitae ipsum, sit amet euismod
      elit. Ut quis egestas libero. Duis vitae lacus dui. Ut varius accumsan felis, quis
      consectetur arcu interdum eu. Nullam dapibus mattis egestas.
    </p>
    <div class="twoTextColumns">
      <h4>PELLENTESQUE CURSUS</h4>
      <p>
        Commodo iaculis. Aliquam erat volutpat. Donec vel ultricies quam, ac laoreet
        purus. Fusce faucibus imperdiet ultrices. Fusce dictum lacus augue, at volutpat
        ante ultricies quis. Nam vitae justo non ligula sodales tempus.
      </p>
      <h4>ALIQUAM ERAT VOLUTPAT</h4>
      <p>
        Quisque ligula orci, ultrices nec dignissim id, pretium eu justo. Aliquam
        dignissim justo ante, nec accumsan lectus lobortis eleifend. Aenean convallis
        lorem diam, ut imperdiet lectus ornare eget. Vestibulum consequat aliquam felis,
        sed porttitor sapien porta et. Mauris vitae ipsum, sit amet euismod elit. Ut quis
        egestas libero. Duis vitae lacus dui.
      </p>
      <p>
        Fusce faucibus imperdiet ultrices. Fusce dictum lacus augue, at volutpat ante
        ultricies quis. Nam vitae justo non ligula sodales tempus.
      </p>
      <h4>DUIS ORNARE TURPIS</h4>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu vulputate varius.
        Quisque ligula orci, ultrices nec dignissim id, pretium eu justo.
      </p>
      <h4>ALIQUAM DIGNISSIM JUSTO</h4>
      <p>
        Ante, nec accumsan lectus lobortis eleifend. Aenean convallis lorem diam, ut
        imperdiet lectus ornare eget. Vestibulum consequat aliquam felis, sed porttitor
        sapien porta et. Mauris vitae condimentum ipsum, sit amet euismod elit. Ut quis
        egestas libero. Duis vitae lacus dui. Ut varius accumsan felis, quis consectetur
        arcu interdum eu. Nullam dapibus mattis egestas.
      </p>
      <h4>PELLENTESQUE CURSUS COMMODO</h4>
      <p>
        Iaculis. Aliquam erat volutpat. Donec vel ultricies quam, ac laoreet purus. Fusce
        faucibus imperdiet ultrices. Fusce dictum lacus augue, at volutpat ante ultricies
        quis. Nam vitae justo non ligula sodales tempus.
      </p>
      <h4>CLASS APTENT TACITI AD LITORA</h4>
      <p>
        torquent per conubia nostra, per inceptos himenaeos. Nullam lacus turpis, iaculis
        quis mattis at, consequat vel sapien. Pellentesque finibus ligula mauris, vitae
        rutrum metus ullamcorper at. Aliquam erat volutpat. Vestibulum pulvinar dui
        sapien, mollis tempus tortor laoreet ac.
      </p>
    </div>
  </div>
  <!--
...
-->
  <div class="chapterPage">
    ...
    <p class="highlight">
      Aenean convallis lorem diam, ut imperdiet lectus ornare eget. Vestibulum consequat
      aliquam felis, sed porttitor sapien porta et.
    </p>
    <div class="twoColumns">
      <div>
        ...
        <p>
          ...
          dignissim justo ante, nec accumsan lectus lobortis eleifend. Aenean convallis
          lorem diam, ut imperdiet lectus ornare eget. Vestibulum consequat aliquam felis,
          sed porttitor sapien porta et. Mauris vitae ipsum, sit amet euismod elit. Ut
          quis egestas libero. Duis vitae lacus dui.
        </p>
        <p>
          Fusce faucibus imperdiet ultrices. Fusce dictum lacus augue, at volutpat ante
          ultricies quis. Nam vitae justo non ligula sodales tempus.
    ...
    <div class="pageBreak"></div>
    <p class="highlight">
      Quisque ligula orci, ultrices nec dignissim id, pretium eu justo. Aliquam dignissim
      justo ante, nec accumsan lectus lobortis eleifend. Aenean convallis lorem diam, ut
      imperdiet lectus ornare eget. Vestibulum consequat aliquam felis, sed sapien porta
      et.
    </p>
    <div class="twoTextColumns">
      <h4>PELLENTESQUE CURSUS</h4>
    ...
    <p class="highlight">
      Aenean convallis lorem diam, ut imperdiet lectus ornare<span class="footnote"
        >Mary Shelley, Frankenstein; or, the Modern Prometheus, ed. M.K. Joseph (Oxford:
        Oxford University Press, 1998), 91.</span
      >
      eget. Vestibulum consequat<span class="footnote">Shelley, Frankenstein, 91.</span>
      aliquam felis, sed porttitor sapien porta et.
    </p>
    <div class="twoTextColumns">
      <h4>ALIQUAM ERAT VOLUTPAT</h4>
    ...
    <div class="twoColumns">
      ...
      <div>
        <h4>ALIQUAM ERAT VOLUTPAT</h4>
        <p>
          Quisque ligula orci, ultrices nec dignissim<span class="footnote"
            >Mary Shelley, Frankenstein; or, the Modern Prometheus, ed. M.K. Joseph
            (Oxford: Oxford University Press, 1998), 91.</span
          >
          id, pretium eu justo. Aliquam dignissim justo ante, nec accumsan lectus lobortis
          eleifend. Aenean convallis lorem diam, ut imperdiet lectus ornare eget.
          Vestibulum consequat aliquam felis, sed porttitor sapien porta et. Mauris vitae
          ipsum, sit amet euismod elit. Ut quis egestas libero. Duis vitae lacus dui.
        </p>
        <p>
          Fusce faucibus imperdiet ultrices. Fusce dictum<span class="footnote"
            >Shelley, Frankenstein, 91.</span
          >
          lacus augue, at volutpat ante ultricies quis. Nam vitae justo non ligula sodales
          tempus.
        </p>
      </div>
    </div>
  ...
  <div class="bibliographyPage">
    ...
    <div class="twoColumns">
      <div>
        <h4>01</h4>
        <p>
          Diaz, S. A., & Hall, R. A. (2020). Fighting fake news: Inspiring critical
          thinking with memorable learning experiences. College & Research Libraries News.
          81(5).
          <a href="https://doi.org/10.5860/crln.81.5.239"
            >https://doi.org/10.5860/crln.81.5.239</a
          >
        </p>
        <h4>02</h4>
        <p>
          Inskeep, S. (2016, December 11). A finders guide to facts. NPR.
          <a href="http://www.npr.org/2016/12/11/505154631/a-finders-guide-to-facts"
            >http://www.npr.org/2016/12/11/505154631/a-finders-guide-to-facts</a
          >
        </p>
        <h4>03</h4>
        <p>
          Kletter, M. (n.d.). The importance of critical thinking in the age of fake news.
          School Library Journal.
          <a
            href="https://www.slj.com?detailStory=the-importance-of-critical-thinking-in-age-of-fake-news-webcast"
            >https://www.slj.com?detailStory=the-importance-of-critical-thinking-in-age-of-fake-news-webcast</a
          >
        </p>
        <h4>04</h4>
        <p>
          Kohnen, A. M. (2019). Teaching online research as a critical literacy skill.
          English Journal, 108(5), 25-30.
        </p>
        <h4>05</h4>
        <p>
          Machete P., Turpin M. (2020) The use of critical thinking to identify fake news:
          a systematic literature review. In: M. Hattingh, M. Matthee, H. Smuts, I.
          Pappas, Y. Dwivedi, & M. Mäntymäki. (eds) Responsible Design, Implementation and
          Use of Information and Communication Technology. Springer, Cham.
          <a href="https://doi-10.1007/978-3-030-45002-1_20"
            >https://doi-10.1007/978-3-030-45002-1_20</a
          >
        </p>
      </div>
      <div class="imageContainerColumns">
